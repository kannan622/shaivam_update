...
public class ThalamChildAdapter extends RecyclerView.Adapter<ThalamChildAdapter.ViewHolder> {
    ...
    public ThalamChildAdapter(Context context, List<Thirumurai_songs> thirumurai_songsList) {
    ...
    @Override
    public ThalamChildAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                            int viewType) {
        View rootView = inflater.inflate(R.layout.adapter_songs, parent, false);
        return new ThalamChildAdapter.ViewHolder(rootView);
    }

    @Override
    public void onBindViewHolder(final ThalamChildAdapter.ViewHolder holder, final int position) {
        ...
        if (mDataset.size() > 0) {
            ...
            holder.songs_text.setText(thirumurai_songs.getThalam().trim());
                ...
                public void onClick(View view) {
                    ...
                    if (currentPosition == holder.getPosition()) {
                        ...
                        try {
                            ...
                            intent.putExtra("thalam", thirumurai_songs.getThalam());
